...
async function getCity() {
    ...
    let apiUrl = "https://api.openweathermap.org/geo/1.0/direct?q=" + "chicago" + "&limit=1&appid=" + apiKey;
    ...
    async function getWeather(lat, lon) {
        const requestUrl = "https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + lon + "&exclude={part}&appid=" + apiKey;
